...
yes | repo init -u https://github.com/lineageos/android.git -b refs/changes/42/436442/22 -g default,-darwin,-muppets,muppets_${DEVICE} --repo-rev=${REPO_VERSION} --git-lfs --no-clone-bundle || if [[ $? -eq 141 ]]; then true; else false; fi
repo version
